...
### 사용되는 태그
<p>
<code><jsp:useBean/></code>&nbsp;:&nbsp;자바빈 객체를 생성해 주기 위한 태그<br>
{% highlight html %}
  {% raw %}
...
<p>
<code><jsp:setProperty/></code>&nbsp;:&nbsp;자바빈 클래스의 속성값을 설정하기 위한 태그<br>
{% highlight html %}
  {% raw %}
...
<p>
<code><jsp:getProperty/></code>&nbsp;:&nbsp;자바빈 클래스의 속성값을 가져오기 위한 태그<br>
{% highlight html %}
  {% raw %}
